...
| Cursor slash commands (`/skills`, `/list`, `/usage`, `/stack-context`, `/production-planning`, `/prd`, `/spec`, `/tickets`, `/prime`, `/validation-tdd`) | `dotfiles\cursor\commands\` | same Agent rebuild; also skill `skills` |
